#The file /boot/grub2/grub.cfg should be owned by the root user to prevent destruction or modification of the file.
#To properly set the owner of /boot/grub2/grub.cfg, run the command:
sudo chown root/boot/grub2/grub.cfg

#The file /boot/grub2/grub.cfg should be group-owned by the root group to prevent destruction or modification of the file.
